...
const CURRENT_TESTNET = {
  ...
  AQUARIUS_ID: "CBQDHNBFBZYE4MKPWBSJOPIYLW4SFSXAXUTSXJN76GNKYVYPCKWC6QUK",
  ...
  POOL_TSTAQUA_XLM: "UNCONFIGURED_TSTAQUA_XLM",
  POOL_TSTVELO_XLM: "UNCONFIGURED_TSTVELO_XLM",
  POOL_TSTUSDC_XLM: "UNCONFIGURED_TSTUSDC_XLM",
  POOL_TSTEURC_XLM: "UNCONFIGURED_TSTEURC_XLM",
};
